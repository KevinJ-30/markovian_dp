...
\begin{itemize}
  ...
  \item \textbf{Privacy.} Report the sole Theorem~5.4 node-substitution
        \texttt{epsilon}. The accountant always uses the in-expansion shell law
        $n_d=K_{\mathrm{out}}^d$ and does not select a different guarantee from
