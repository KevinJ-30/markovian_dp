...
def load_relbench(dataset_name: str, task_name: str, *,
    ...
    # "predict 0", and models.objectives.trivial_baseline must (and now does) subtract
...
def parse_relbench_name(name: str):
    ...
    Also accepts the registered shorthands in src/data/datasets.py.
    """
    body = name.split(':', 1)[1]
    if '/' not in body:
        raise ValueError(
